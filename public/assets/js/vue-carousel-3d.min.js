            ...
            methods: {
                ...
                calculatePosition: function(t, e, n) {
                    var i = this.parent.disable3d ? 0 : parseInt(this.parent.inverseScaling) + 100 * (t + 1),
                        ...
                        o = "auto" === this.parent.space ? parseInt((t + 1) * (this.parent.width / 1.7), 10) : parseInt((t + 1) * this.parent.space, 10),
                        s = e ? "translateX(" + o + "px) translateZ(-" + i + "px)" : "translateX(-" + o + "px) translateZ(-" + i + "px)",
